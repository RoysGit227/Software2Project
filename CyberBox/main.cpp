...
int main(int argc, char *argv[])
{
    ...
    //Connect Signals from Attacker to NetWork for CIA Attacks
    ...
    //Connect Signals from Attacker to SPO2 Sensor for Integrity Attacks
    ...
    //Start with network device as host
    netWork.addDevice(QString("Router Pi"));

    //Plot Patient Data for each Sensor UI
