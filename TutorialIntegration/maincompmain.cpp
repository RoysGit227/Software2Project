...
void MainCompMain::on_EncryptionPushButton_clicked()
...
//When we have selected DES in Text
    ...
    //When we have selected File Encryption
        else if(ui->TypeComboBox->currentIndex() == 3)
        {
        int key = ui->lineEdit_key->text().toInt();
        encryptedText = TextFileE(plainText, key);
...
void MainCompMain::on_DecryptionPushButton_clicked()
{
...
//When we have selected DES in Text
    ...
    //When we have selected File Encryption
        ...
        {
        int key = ui->lineEdit_key->text().toInt();
        plainText = TextFileD(encryptedText, key);;
...
void MainCompMain::on_Reset_triggered()
{
...
void MainCompMain::on_ClearPlainText_triggered()
{
    ui->plainTextEdit_plain->clear();
}

//To clear Encrypted Text
void MainCompMain::on_CleaEncryptedText_triggered()
{
    ui->plainTextEdit_encrypted->clear();
}

//To Exit
void MainCompMain::on_Exit_triggered()
{
    exit(0);
}

//QT Creator help
void MainCompMain::on_actionAbout_Qt_triggered()
{
    QMessageBox::aboutQt(this);
}

//Check and see if of type of method has changed
void MainCompMain::on_TypeComboBox_currentTextChanged(const QString &arg1)
{
...
QString MainCompMain::CaesarCipherE(QString plainText, int key)
{
...
QString MainCompMain::CaesarCipherD(QString encryptedText, int key)
{
...
QString MainCompMain::DESE(QString plainText, std::string key)
{
...
QString MainCompMain::iDESE(QString encryptedText, std::string key)
{
    std::vector< std::string > keys = keyGeneration(key);
...
std::vector< std::string > MainCompMain::keyGeneration(std::string key)
{
...
QString MainCompMain::DESEncryption(std::string dataBlock, std::vector< std::string > keys)
{
...
std::string MainCompMain::Xor(std::string str1, std::string str2)
{
...
//Needs comments
std::string MainCompMain::Function(std::string str1, std::string str2)
{
    // result is 48 bit
...
//Needs comments
std::string MainCompMain::eBit(std::string str)
{
    std::string result = "";
...
//DES with Text
QString MainCompMain::DESD(QString plainText, std::string key)
{
    std::vector< std::string > keys = keyGeneration(key);
...
QString MainCompMain::iDESD(QString encryptedText, std::string key)
{
    std::vector< std::string > keys = keyGeneration(key);
    std::reverse(keys.begin(), keys.end());
...
std::vector< std::string > MainCompMain::BinaryAscii(std::string str)
{
...
std::string MainCompMain::BinaryAsciiToText(std::string str)
{
...
std::string MainCompMain::CharToBinaryAscii(char ch)
{
    return std::bitset<8>(int(ch)).to_string();
}

char MainCompMain::BinaryAsciiToChar(std::string binaryAscii)
{
...
QString MainCompMain::TextFileD(QString encryptedText, int key){
