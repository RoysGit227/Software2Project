...
{
    ui->setupUi(this);
    QPixmap pix("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/b01-raspi4-start.jpeg");
    ui->labelAttacker->setPixmap(pix.scaled(201,131,Qt::KeepAspectRatio));

    QPixmap pix1("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/b01-raspi4-start.jpeg");
    ui->labelMain->setPixmap(pix1.scaled(201,131,Qt::KeepAspectRatio));

    QPixmap pix2("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/Netgear-GS108-8-Port-Switch");
    ui->labelSwitch->setPixmap(pix2.scaled(251,151,Qt::KeepAspectRatio));

    QPixmap pix3("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/RaspberryPi.jpeg");
    ui->labelSN1->setPixmap(pix3.scaled(121,91,Qt::KeepAspectRatio));

    QPixmap pix4("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/RaspberryPi.jpeg");
    ui->labelSN2->setPixmap(pix4.scaled(121,91,Qt::KeepAspectRatio));

    QPixmap pix5("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/RaspberryPi.jpeg");
    ui->labelSN3->setPixmap(pix5.scaled(121,91,Qt::KeepAspectRatio));

    QPixmap pix6("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/BITalino.jpg");
    ui->labelBIT1->setPixmap(pix6.scaled(121,191,Qt::KeepAspectRatio));

    QPixmap pix7("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/BITalino.jpg");
    ui->labelBIT2->setPixmap(pix7.scaled(121,191,Qt::KeepAspectRatio));

    QPixmap pix8("/Users/jarel/OneDrive/Documents/Software2Project-main/CyberBox/WebPics/BITalino.jpg");
